...
SELECT * FROM books WHERE genre = 'fiction' ORDER BY year ASC;

-- 17. Select all available books with a rating of 9.0 or higher,
--     ordered by rating from highest to lowest.
SELECT * FROM books WHERE rating >= 9.0 ORDER BY rating DESC; 
...
VALUES ('Harry Potter', 'JK Rowling', 'fantasy', 2026, 9.5);
